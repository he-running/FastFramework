...
import com.he.data.executor.JobExecutor;
...
import com.he.presentation.UIThread;
...
public class ApplicationModule {
    private final LocalApplication application;

    public ApplicationModule(LocalApplication application) {
